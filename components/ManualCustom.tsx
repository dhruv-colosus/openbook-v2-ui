    ...
    <>
      <div className="mb-12">
        ...
        <p className="mb-4">
          ...
          and find the colors section. Change the given 6 colors to whatever
          theme you have in mind.
        </p>

        <h4 className="text-2xl underline mb-3 ">The colors are as follows:</h4>
        <ul className="p-8 bg-secondary-bg rounded-lg">
          ...
          <li>
            iii. secondary-bg: The background color of the search bar above
        ...
        <p className="mt-4 text-xs pl-12">
          <span className="italic font-bold">NOTE:</span> The color of the
          wallet is currently uncustomizable and will require some time to
          patch.
        </p>
      </div>
      ...
      <div className="mb-12">
        ...
        <p className="mb-4">
          ...
          <span className="font-bold italic"> public folder</span> and follow
          these 2 steps:
        </p>
        ...
        <div className="p-8 rounded-lg bg-secondary-bg">
          ...
          <h3 className="pl-8">
            ii. Add your logo as png and ico files and name them logo.png and
            favicon.ico
          </h3>
        </div>
      ...
      <div className="mb-12">
        ...
        <h3 className="p-8 rounded-lg bg-secondary-bg">
          Go to the
          <span className="italic font-bold"> utils</span> folder and change the
